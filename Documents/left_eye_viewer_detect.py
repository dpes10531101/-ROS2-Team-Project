...
class LeftEyeViewerFlip(Node):
    ...
    def cb(self, msg: Image):
        ...
        self.frame = img   # guardamos la imagen tal cual llega (boca abajo)
    ...
    def draw(self):
        ...
        img = cv2.flip(self.frame, -1)   # primero lo ponemos al derecho
        img = self.annotate(img)        # luego le pintamos las cajas
